  ...
  template: `
    <section class='container'>
      <div class='h-screen w-full flex flex-col justify-center items-center text-center'>
        ...
        <button routerLink='/home' class='w-11/12 lg:w-1/4 h-10 my-4 uppercase bg-white hover:shadow-lg hover:bg-gray-700 hover:text-white transition-all shadow-inner rounded-lg'>
