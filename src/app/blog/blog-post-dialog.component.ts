    ...
    <div class="container h-full w-full text-center">
      ...
      <div class="w-full flex flex-col items-center">
        <div class="w-full mt-4 space-y-2 flex flex-col items-center">
          <label class="text-xs font-light text-gray-500" for="title"
            >Title</label
          >
          <input
            ...
            #title
          />
          <label class="text-xs font-light text-gray-500" for="date"
            >Date</label
          >
          <mat-form-field>
            <input
          ...
          <label class="text-xs font-light text-gray-500" for="link"
            >Link URL</label
          >
          <input
            class="w-full focus:outline-none ring-white focus:ring-2 focus:ring-gray-700 p-2 rounded-xl bg-slate-100 border-none font-light text-gray-600"
            ...
            #link
          />
          <label class="text-xs font-light text-gray-500" for="content"
            >Content</label
          >
          <input
            class="w-full focus:outline-none ring-white focus:ring-2 focus:ring-gray-700 p-2 rounded-xl bg-slate-100 border-none font-light text-gray-600"
